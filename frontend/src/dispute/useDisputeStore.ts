...
const INITIAL_EVIDENCES: DisputeEvidenceDTO[] = [
  {
    ...
    description: 'Vết trầy xước sâu cản trước gần cụm đèn sương mù bên trái sau khi trả xe.',
  ...
  },
  {
    ...
    description: 'Xung đột kháng trở cảm biến siêu âm trong phiên #105 mốc thời gian 14:22.',
...
const INITIAL_DEFECTS: DefectMarker3D[] = [
  {
    ...
    label: 'Vết Xước Cản Trước',
    severity: 'CRITICAL',
    photoUrl: 'https://storage.evshare.io/evidences/defect_front_bumper.jpg',
    uploaderName: 'Alice Owner',
    timestamp: '08:15',
    description: 'Vết trầy xước sâu cản trước gần cụm đèn sương mù bên trái.',
  },
  {
    id: 'DEF-02',
    evidenceId: 2,
    position: [-0.45, 0.35, -2.15],
    label: 'Lỗi Cảm Biến Siêu Âm',
    severity: 'MODERATE',
...
const INITIAL_DISPUTE: DisputeDTO = {
  ...
  description:
    'Xe bàn giao sau phiên sử dụng #105 có vết trầy sâu ở cản trước và lệch cảm biến siêu âm trước trái. Người sử dụng từ chối nhận lỗi gây hư hại.',
  status: 'OPEN',
  resolutionSummary: undefined,
  mediationNotes: 'Đang chờ nhân viên nền tảng tiến hành hòa giải chính thức.',
  proposedResolution: 'Đang chờ nhân viên xem xét.',
