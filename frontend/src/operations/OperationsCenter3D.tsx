...
export const OperationsCenter3D: React.FC<OperationsCenter3DProps> = ({
  ...
  const cameraButtons = [
    { key: 'HANGAR_OVERVIEW', label: 'OVERVIEW', preset: OPERATIONS_CAMERA_PRESETS.HANGAR_OVERVIEW },
    { key: 'QR_STATION_FOCUS', label: 'QR SCANNER', preset: OPERATIONS_CAMERA_PRESETS.QR_STATION_FOCUS },
    { key: 'DISPATCH_CONSOLE_FOCUS', label: 'DISPATCH CONSOLE', preset: OPERATIONS_CAMERA_PRESETS.DISPATCH_CONSOLE_FOCUS },
    { key: 'FLEET_STATUS_FOCUS', label: 'FLEET MATRIX', preset: OPERATIONS_CAMERA_PRESETS.FLEET_STATUS_FOCUS },
    { key: 'NOTIFICATION_BOARD_FOCUS', label: 'ALERTS STREAM', preset: OPERATIONS_CAMERA_PRESETS.NOTIFICATION_BOARD_FOCUS },
    { key: 'INSPECTION_BAY_FOCUS', label: 'INSPECTION BAY', preset: OPERATIONS_CAMERA_PRESETS.INSPECTION_BAY_FOCUS },
  ];
