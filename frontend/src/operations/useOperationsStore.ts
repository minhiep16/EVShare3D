...
const INITIAL_ALERTS: OperationalAlertItem[] = [
  {
    id: 'ALT-01',
    title: 'FAST CHARGER 150KW CONNECTED',
    severity: 'INFO',
    timestamp: '10:14 AM',
    message: 'VF8 charging in Bay 01. SoC reached 92%. Trickle balancing active.',
  ...
  {
    id: 'ALT-02',
    title: 'CHECK-OUT INSPECTION SCHEDULED',
    severity: 'WARNING',
    timestamp: '10:08 AM',
    message: 'VF9 inbound from session #501. Reserved return bay: BAY 02.',
    isAcknowledged: false,
  ...
  {
    id: 'ALT-03',
    title: 'FRONT SENSOR ADVISORY',
    severity: 'CRITICAL',
    timestamp: '09:42 AM',
    message: 'LiDAR optical occlusion flag on VF6. Calibration maintenance required.',
    isAcknowledged: false,
...
export const useOperationsStore = create<OperationsStore>((set, get) => ({
  ...
  isSubmitting: false,
  operationMessage: 'Operations sector online. Stand by for vehicle dispatch.',
  operationError: null,
