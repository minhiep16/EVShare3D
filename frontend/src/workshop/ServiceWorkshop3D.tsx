...
export const ServiceWorkshop3D: React.FC<ServiceWorkshop3DProps> = ({
  ...
  const cameraButtons = [
    { key: 'WORKSHOP_OVERVIEW', label: 'OVERVIEW', preset: WORKSHOP_CAMERA_PRESETS.WORKSHOP_OVERVIEW },
    { key: 'HYDRAULIC_LIFT_FOCUS', label: 'HYDRAULIC LIFT', preset: WORKSHOP_CAMERA_PRESETS.HYDRAULIC_LIFT_FOCUS },
    { key: 'DIAGNOSTIC_CART_FOCUS', label: 'DIAGNOSTIC CART', preset: WORKSHOP_CAMERA_PRESETS.DIAGNOSTIC_CART_FOCUS },
    { key: 'PARTS_RACK_FOCUS', label: 'PARTS RACK', preset: WORKSHOP_CAMERA_PRESETS.PARTS_RACK_FOCUS },
    { key: 'WORK_ORDER_STELA_FOCUS', label: 'WORK ORDER', preset: WORKSHOP_CAMERA_PRESETS.WORK_ORDER_STELA_FOCUS },
    { key: 'UNDERCARRIAGE_INSPECTION', label: 'UNDERCARRIAGE', preset: WORKSHOP_CAMERA_PRESETS.UNDERCARRIAGE_INSPECTION },
  ];
